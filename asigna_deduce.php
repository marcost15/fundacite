...
$f1->textField('Porcentaje','porc',_FH_FLOAT,10,10);
$f1->setHelpText('porc','Por Favor Introduzca los decimales con punto');
$f1->textField('Monto','monto',_FH_FLOAT,10,10);
$f1->setHelpText('monto','Por Favor Introduzca los decimales con punto');
$f1->textField('Formula','formula',_FH_STRING,40,255);
$f1->setHelpText('formula','Por Favor Introduzca los decimales con punto');
