...
<html>
	<head>
		...
		<title><?php echo ((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, 'FUNDACITE') : smarty_modifier_default($_tmp, 'FUNDACITE')); ?>
</title>
	...
	<body background="./imagenes/papel_tapiz.jpg" topmargin="0" leftmargin="0">
		...
		<!-- div id="banner"><img src="./imagenes/banner33.jpg" width="1052" height="163"/></div -->
