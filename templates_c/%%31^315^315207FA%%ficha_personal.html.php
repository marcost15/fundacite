<?php /* Smarty version 2.6.26, created on 2015-08-19 18:57:44
...
-<?php echo $this->_tpl_vars['ficha']['cedula']; ?>
	...
	<tr>
		...
		<td><?php echo $this->_tpl_vars['ficha']['fecha_ing']; ?>
</td>
	</tr>
	<tr>
		<th>Grado de Intruccion</th>
		<td><?php echo $this->_tpl_vars['ficha']['grado_instruccion_id']; ?>
</td>
	</tr>
	<tr>
		<th>Cargo</th>
	...
	<tr>
		<th>Clasificacion</th>
		<td><?php echo $this->_tpl_vars['ficha']['clasificacion_id']; ?>
</td>
	</tr>
	<tr>
		<th>Departamento</th>
	...
	<tr>
		<th>Profesion</th>
		<td><?php echo $this->_tpl_vars['ficha']['profesion_id']; ?>
</td>
	</tr>
	<tr>
		<th>Salario Minimo</th>
		<td><?php echo $this->_tpl_vars['ficha']['salario']; ?>
</td>
	</tr>
	<tr>
		<th>Salario Normal</th>
		<td><?php echo $this->_tpl_vars['ficha']['salario2']; ?>
</td>
	</tr>
</table>
<p></p>
