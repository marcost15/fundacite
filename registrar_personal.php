...
$f1->selectField($star."Grado de Instruccion", "grado_instr",bd_lista_grado_instruccion(),FH_NOT_EMPTY,true);
$f1->selectField($star."Profesión", "profesion_id",bd_lista_profesiones(),FH_NOT_EMPTY,true);
$f1->textField('Salario','salario',FH_DIGIT,40,40,"onkeyup=\"return ValNumero(this);\"");
